...
SPECTACULAR_SETTINGS = {
    "TITLE": "Ledger-Based Wallet API",
    "DESCRIPTION": "Credit, debit, balance and ledger-history endpoints.",
    "VERSION": "1.0.0",
...
# منبع واحد برای دقت اعشاری؛ مدل‌ها و validation باید همیشه از همینجا بخونن
